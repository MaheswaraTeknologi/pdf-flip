...
!(function (M, L, C, a) {
  (M.fn.flipBook = function (e) {
    ...
    (FLIPBOOK.Main = function (e, t) {
          ...
          (function () {
            ...
            if ('Microsoft Internet Explorer' == navigator.appName) {
              ...
              'Netscape' == navigator.appName &&
                ((t = navigator.userAgent), null != new RegExp('Trident/.*rv:([0-9]{1,}[.0-9]{0,})').exec(t) && (e = parseFloat(RegExp.$1)));
            return e;
      ...
      if (
        ...
        P.isMobile &&
          ...
          P.pageTextureSizeMobile && (P.pageTextureSize = P.pageTextureSizeMobile)),
        ...
        'webgl' == P.viewMode &&
          (!this.hasWebGl ||
            (parseFloat(!!(w = (v = (v || navigator.userAgent).toLowerCase()).match(/android\s([0-9\.]*)/)) && w[1]) < P.minimumAndroidVersion &&
              this.isAndroid)) &&
          (P.viewMode = '3d'),
        ...
        P.backgroundTransparent && (P.backgroundColor = 'none'),
          ...
          '' != P.backgroundImage &&
            (this.wrapper.css('background', 'url(' + P.backgroundImage + ') no-repeat'), this.wrapper.css('background-size', 'cover')),
        ...
        B.on('pageLoaded', function (e) {
          ...
          B.on('pdfinit', function () {
            ...
            (P.pageWidth = parseInt((i * n.viewportOriginal.width) / n.viewportOriginal.height)),
              (P.pageHeight = i),
              (P.pw = P.pageWidth),
              (P.ph = P.pageHeight),
            ...
            ? ((P.btnClose.enabled = !0),
              ...
              P.lightBoxOpened
                ...
                : P.lightboxPreload &&
                  ...
                  'webgl' == P.viewMode &&
                    ('undefined' != typeof THREE || FLIPBOOK.scriptsAdded[FLIPBOOK.threejsSrc] || n.loadScript(FLIPBOOK.threejsSrc, function () {}))),
      ...
      function x() {
        P.pdfBrowserViewerFullscreen
          ...
          : M('<object type="application/pdf"/>').width('100%').height('100%').attr('data', P.pdfUrl).appendTo(n.$elem);
      }
      function T() {
        if (!n.disposed) {
      ...
      function y() {
        (n.id = Date.now()),
          n.addPageItems(),
          P.pdfMode ? n.initPdf(P.btnSearch.enabled) : ((P.btnSearch.enabled = !1), n.initJpg()),
    ...
    (FLIPBOOK.Main.prototype = {
      ...
      updateSkinColors: function () {
        var e = this.options;
        e.skinColor && this.wrapper.find('.skin-color').css('color', e.skinColor),
          e.skinBackground && this.wrapper.find('.skin-color-bg').css('background', e.skinBackground);
      },
          ...
          void 0 !== this.Book
            ? (this.Book.enable(),
              ...
              this.lightboxStartPage
                ...
                : this.options.lightboxStartPage && this.goToPage(this.options.lightboxStartPage, !0),
      ...
      setHash: function (e) {
        e < 1 && (e = 1),
          this.options.deeplinkingEnabled && this.Book.enabled && (L.location.hash = '#' + this.options.deeplinkingPrefix + String(e));
      },
      clearHash: function () {
        L.location.hash = '';
      },
      getPageFromHash: function () {
        ...
        return (
          -1 !== t.indexOf(o) && ((e = parseInt(L.location.hash.replace(/#/g, '').replace(this.options.deeplinkingPrefix, ''))), isNaN(e) && (e = 0)),
          e
        );
      },
      initColors: function () {
        ...
        if (void 0 !== this.currentPage) {
          ...
          t && (i = this.options.pages.length - i),
            this.options.singlePageMode || this.Book.singlePage
              ...
              : ((this.cPage =
                  o < i || (i == o && o % 2 == 0) ? [(e = o) - 1] : i < 1 ? ((e = 1), [0]) : ((e = String(i) + '-' + String(i + 1)), [i - 1, i])),
                this.setHash(i)),
      ...
      initPdf: function (e) {
        if (!this.started) {
          ...
          this.setLoadingProgress(0.3),
            ...
            'https:' == location.protocol && (t.options.pdfUrl = t.options.pdfUrl);
      ...
      toggleSound: function () {
        var e = this.options;
        e.sound
          ? ((e.sound = !1), this.btnSound.$icon.hide(), this.btnSound.$iconAlt.show())
          : ((e.sound = !0), this.btnSound.$icon.show(), this.btnSound.$iconAlt.hide());
      },
          ...
          (s.onload = s.onreadystatechange =
            function (e, t) {
              (t || !s.readyState || /loaded|complete/.test(s.readyState)) &&
                ((s.onload = s.onreadystatechange = null), (s = a), t || (i && i.call(n)), (FLIPBOOK.scriptsLoaded[o] = !0));
            }),
          (s.src = o);
      },
      createBook: function () {
        ...
        if (
          ('material' != t.icons ||
            ...
            M('head').append('<link rel="stylesheet" href="https://fonts.googleapis.com/icon?family=Material+Icons">')),
        ...
        if (
          ...
          this.options.numPages % 2 == 0 ||
            ...
            ((this.oddPages = !0), (this.options.oddPages = !0), this.options.pages.push({ src: this.options.assets.preloader, thumb: '' })),
          0 < n.options.pages.length)
        )
          for (i = 0; i < n.options.pages.length; i++)
            void 0 !== n.options.pages[i].htmlContent &&
              ((n.options.hasHtmlContent = !0), (n.options.pages[i].htmlContent = M(n.options.pages[i].htmlContent)));
        function l() {
      ...
      onBookCreated: function () {
        ...
        M(L).resize(function () {
          ...
          this.bookLayer.bind('DOMMouseScroll', function (e) {
            if (
              t.Book.enabled &&
              (t.options.lightBox || t.fullscreenActive || (!t.options.wheelDisabledNotFullscreen && !t.bodyHasVerticalScrollbar()))
            )
          ...
          this.bookLayer.bind('mousewheel', function (e) {
            if (
              ...
              return (
                e.stopPropagation(), e.preventDefault(), e.originalEvent.wheelDelta < 0 ? t.zoomOut(e.originalEvent) : t.zoomIn(e.originalEvent), !1
              );
          }),
          ...
          L.jQuery(this.bookLayer).swipe({
            ...
            pinchStatus: function (e, t, o, i, n, s, a) {
              'start' == t && (l.zoomStart = l.zoom),
                1 < s && 'move' == t && (e.preventDefault(), e.scale && (a = e.scale), l.zoomTo(l.zoomStart * a, 0, e));
            },
            fingers: 2,
            pinchThreshold: 0,
      ...
      handleFsChange: function (e) {
        if (this.Book && this.Book.enabled) {
          ...
          (C.fullscreenElement || C.webkitFullscreenElement || C.mozFullScreenElement || C.msFullscreenElement) === this.fullscreenElement ||
          this.isFullscreen
      ...
      createTocItem: function (o, e, t) {
        ...
        t || (t = 0),
          ...
          t ? (n.css('margin-top', '8px'), n.css('padding-bottom', '0')) : (n.css('margin-right', '15px'), n.css('padding-left', '10px'));
      ...
      enableButton: function (e, t) {
        void 0 !== e &&
          (t ? (e.css('opacity', '1'), e.css('pointer-events', 'auto')) : (e.css('opacity', '0.2'), e.css('pointer-events', 'none')),
          (e.enabled = t));
      },
      resize: function () {
        if (this.Book && this.Book.enabled) {
      ...
      toggleToc: function (e) {
        this.tocCreated
          ? (!this.tocShowing || e
              ? (this.closeMenus(), (this.tocShowing = !0), this.tocHolder.show(), this.tocScroll.refresh())
      ...
      toggleSearch: function (e) {
        this.thumbs || this.createThumbs(),
          ...
          this.searchShowing
            ...
            : (this.closeMenus(), this.thumbs.show(), this.thumbs.showSearch(), (this.searchShowing = !0)),
          this.resize();
      },
      toggleBookmark: function (e) {
        this.thumbs || this.createThumbs(),
          ...
          this.bookmarkShowing
            ...
            : (this.closeMenus(), this.thumbs.show(), this.thumbs.showBookmarks(), (this.bookmarkShowing = !0)),
          this.resize();
      },
      closeMenus: function () {
      ...
      toggleShareMenu: function () {
        if (this.shareMenu)
          ...
          (this.share = new Share(o[0], {
            networks: { google_plus: i.google_plus, twitter: i.twitter, facebook: i.facebook, pinterest: i.pinterest, email: i.email },
          })),
            this.closeMenus(),
      ...
      toggleExpand: function (e) {
        (this.browserFullscreen = !0),
          screenfull.enabled ? screenfull.toggle(this.fullscreenElement) : ((this.isFullscreen = !this.isFullscreen), this.handleFsChange());
      },
      expand: function () {},
      ...
      initEasing: function () {
        L.jQuery.extend(L.jQuery.easing, {
          ...
          easeInOutElastic: function (e, t, o, i, n) {
            ...
            return t < 1
              ? r * Math.pow(2, 10 * (t -= 1)) * Math.sin(((t * n - s) * (2 * Math.PI)) / a) * -0.5 + o
              : r * Math.pow(2, -10 * (t -= 1)) * Math.sin(((t * n - s) * (2 * Math.PI)) / a) * 0.5 + i + o;
          },
    ...
    (FLIPBOOK.Thumbnails = function (o) {
      ...
      if (((this.main = o), (this.options = n), (this.wrapper = e), (this.active = null), n.btnThumbs.enabled)) {
        ...
        (this.thumbScroll = new FLIPBOOK.IScroll(this.thumbsWrapper[0], { bounce: !1, mouseWheel: !0, scrollbars: !0, interactiveScrollbars: !0 })),
          o.initColors();
      }
    }),
      ...
      findInPage: function (t, o) {
        ...
        this.main.pdfService.findInPage(t, o, function (e) {
          0 < e &&
            (i.showThumb(o),
            i.pagesFound++,
            i.$findInfo.show().text(i.pagesFound + ' ' + i.options.strings.pagesFoundContaining + ' "' + t + '"'),
            i.main.mark(t));
        });
      },
    }),
          ...
          return new Promise(
            function (e) {
              ...
              (i = i || s.documentElement),
                / Version\/5\.1(?:\.\d+)? Safari\//.test(navigator.userAgent) ? i[t]() : i[t](n ? Element.ALLOW_KEYBOARD_INPUT : {}),
                this.on('change', o);
            }.bind(this)
          );
        },
  ...
  (function (e) {
    ...
    function i(e, f) {
          ...
          if (!t.pointerType || 'mouse' != t.pointerType || 0 != f.fallbackToMouseEvents) {
            ...
            return (
              ...
              !i || G === f.fingers || f.fingers === Be || k()
                ? ((ee = E()), 2 == G && (O(1, i[1]), (W = V = I(J[0].start, J[1].start))), (f.swipeStatus || f.pinchStatus) && (o = m(t, X)))
                : (o = !1),
              !1 === o
                ? (m(t, (X = Me)), o)
                : (f.hold &&
          ...
          if (
            ...
            2 == G &&
              (0 == W
                ...
                : (y(p[1]), (V = I(J[0].end, J[1].end)), J[0].end, J[1].end, (Z = U < 1 ? ue : ce)),
              (U = ((V / W) * 1).toFixed(2)),
              (q = Math.abs(W - V))),
      ...
      function m(e, t) {
        ...
        return (
          ...
          S() && P() && !1 !== o
            ...
            ? (o = r(e, t, we))
            : !((1 !== G && Le) || !(isNaN(R) || R < f.threshold) || !w()) && !1 !== o && (o = r(e, t, ke)),
          t === Me && n(),
          t === ye && ((i && i.length) || n()),
          o
        );
      ...
      function r(e, t, o) {
        ...
        if (o == be) {
          if (
            ...
            f.swipeStatus && !1 === (i = f.swipeStatus.call(Y, e, t, N || null, R || 0, $ || 0, G, J, j)))
          )
            return !1;
          if (t == ye && c()) {
            if (
        ...
        if (o == me) {
          if (
            ...
            f.pinchStatus && !1 === (i = f.pinchStatus.call(Y, e, t, Z || null, q || 0, $ || 0, G, U, J)))
          )
            return !1;
          if (t == ye && p())
            switch (Z) {
              case ce:
                Y.trigger('pinchIn', [Z || null, q || 0, $ || 0, G, U, J]),
                  f.pinchIn && (i = f.pinchIn.call(Y, e, Z || null, q || 0, $ || 0, G, U, J));
                break;
              case ue:
                Y.trigger('pinchOut', [Z || null, q || 0, $ || 0, G, U, J]),
                  f.pinchOut && (i = f.pinchOut.call(Y, e, Z || null, q || 0, $ || 0, G, U, J));
            }
        }
        return (
          o == ke
            ...
            : o == we &&
              ((t !== Me && t !== ye) ||
                (clearTimeout(se), (ne = null), Y.trigger('longtap', [e.target]), f.longTap && (i = f.longTap.call(Y, e, e.target)))),
          i
        );
      }
      function l() {
      ...
      function T(e) {
        Y &&
          (!0 === e ? (Y.bind(_, o), Y.bind(D, i), K && Y.bind(K, s)) : (Y.unbind(_, o, !1), Y.unbind(D, i, !1), K && Y.unbind(K, s, !1)),
      ...
      function F(e, t) {
        ...
        var o,
          ...
          h =
            ...
            (r = s.y - n.y),
            (l = Math.atan2(r, a)),
            (d = Math.round((180 * l) / Math.PI)) < 0 && (d = 360 - Math.abs(d)),
            d);
      ...
      return (
        ...
        (t.prototype.inject_stylesheet = function (e) {
          ...
          return this.el.head.querySelector('link[href="' + e + '"]')
            ? void 0
            : ((t = document.createElement('link')).setAttribute('rel', 'stylesheet'), t.setAttribute('href', e), this.el.head.appendChild(t));
        }),
        ...
        (t.prototype.default_title = function () {
          var e;
          return (e = document.querySelector('meta[property="og:title"]') || document.querySelector('meta[name="twitter:title"]'))
        ...
        (t.prototype.default_image = function () {
          var e;
          return (e = document.querySelector('meta[property="og:image"]') || document.querySelector('meta[name="twitter:image"]'))
            ? e.getAttribute('content')
            : void 0;
        }),
        ...
        (t.prototype.set_global_configuration = function () {
          ...
          for (t in ((n = []), (i = this.config.networks))) {
            ...
            this.config.networks[t].enabled ? ((e = 'block'), (this.config.enabled_networks += 1)) : (e = 'none'),
